...
@section('content')
    ...
    <div class="flex gap-6 px-12">
        <!-- Product List -->
        <div class="flex flex-col border border-none p-10 space-y-8">
            <!-- Product 1 -->
            <div class="flex items-center border-b border-gray-300 pb-6 space-x-4">
        ...
        <div class="flex justify-end">
            <div class="w-[376px] h-[434px] border-2 border-gray-300 p-6 space-y-6">
                ...
                <button class="w-full py-2 bg-blue-900 text-white text-lg font-semibold rounded-lg">Proceed To
                    Checkout</button>
                <button class="w-full py-2 border border-blue-900 text-blue-900 text-lg font-semibold rounded-lg">Continue
                    Shopping</button>
            </div>
        </div>
    </div>
