     ...
     <form class="flex" action="" method="post">
          ...
          <div class="w-[60%] p-40">
               <div>
                    ...
                    <h1 class = 'font-rufina'style="font-size: 3rem; color: #1d4ed8; font-weight: bold; padding-bottom: 1rem;">Your first step towards discovering your unique style</h1>
               ...
               <div>
                    <div class="pb-4 md:pd-6 font-poppins", style > 
                         <input 
                              ...
                              id="email" 
                              placeholder="Email" 
                              class="border border-slate-300 py-6 px-6 rounded-md w-full focus:border-blue-500 focus:outline-none"
                         >
                         @error('email')
                    ...
                    <div class="pb-20 md:pb-0 relative font-poppins"> 
                         ...
                         <!-- Tambahkan checkbox sebagai elemen anak dengan posisi absolute -->
          ...
          <div class="text-center mt-10 justify-center min-h-20">Don't have an account? <a href="/register"class="text-blue-700 cursor-pointer">Sign Up</a>
          </div>
          ...
          <div class="w-[40%] hidden md:block">
               <img src="/img/register.png" alt="WearIt" class="w-full h-screen object-cover">
