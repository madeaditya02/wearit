...
@section('content')
    <form method="POST" action="/admin/discount" class="grid grid-cols-2 gap-x-12 gap-y-8">
        ...
        <div>
            ...
            <input type="number" id="id_produk" name="id_produk" placeholder="ID Produk" value="{{ old('id_produk') }}"
        ...
        <div class="col-span-2">
            <button class="px-3 py-2 bg-primary-light text-white rounded-lg hover:bg-blue-700">Add Discount</button>
        </div>
    </form>
@endsection
