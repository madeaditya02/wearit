...
<body class="font-poppins">
    <nav class="navbar px-8 sm:px-16 py-6 flex justify-between fixed top-0 left-0 right-0 z-50 transition duration-300 bg-white"
        ...
        <div
            ...
            <a href="#" class="px-3 py-1.5 rounded-lg hover:bg-gray-50">Favorite</a>
            <a href="#" class="px-3 py-1.5 rounded-lg hover:bg-gray-50">Shop</a>
        </div>
        <div class="flex md:gap-8 gap-4 items-center">
            <a href="#" class="p-1.5 hover:bg-gray-50">
            ...
            @guest
                <a href="#" class="px-5 py-1.5 border border-primary">
                    Login
                </a>
            @endguest
            @auth
