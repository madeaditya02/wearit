...
@section('content')
    <div class="container mx-auto p-6">
        ...
        <div class="flex items-center justify-center mb-6">
            <input type="text" placeholder="Search" class="p-2 border-2 border-gray-300 rounded-l-lg" />
            <select class="p-2 bg-blue-500 text-white rounded-r-lg hover:bg-blue-600 border-2 border-blue-500">
                <option>New</option>
                ...
                <div class="grid grid-cols-8 gap-5">
                    ...
                    <div class="col-span-8 sm:col-span-4 md:col-span-2 h-80 mb-3">
                        <img src="https://colorbox.co.id/cdn/shop/files/I-TSKKEY224L180_BLACK_4_5b6fec48-10a2-4425-98c8-f0f86b4f3896.jpg?v=1732775288&width=700"
                            alt="Baju" class="object-cover h-full w-full">
                        <div class="text-center mt-2">
                            ...
                            <div class="flex justify-center items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-yellow-500" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path
                                        d="M10 15l-5.6 3.3 1.4-6.1L1 7.5l6.2-.5L10 1l2.8 5 6.2.5-4.8 4.7 1.4 6.1L10 15z" />
                                </svg>
        ...
        <body class="bg-gray-100 flex items-center justify-center h-screen">
            ...
            <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                <div class="bg-white rounded-lg shadow-lg max-w-3xl w-full p-6 relative flex">
                    ...
                    <div class="w-1/2">
                        <img src="https://colorbox.co.id/cdn/shop/files/I-JKWKEY224L044_GREY_4_7e02bf76-ae18-48c5-92b1-72788c5517e0.jpg?v=1732774884&width=700"
                            alt="Printed Loose T-shirt" class="rounded-md">
                    </div>
                    ...
                    <div class="w-1/2 pl-6">
                        ...
                        <p class="text-gray-600 mt-4">Relaxed-fit shirt. Camp collar and short sleeves. Button-up front.
                        </p>
