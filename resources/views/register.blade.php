...
<body>
    <div class="flex">
        <div class ="w-[40%] hidden md:block">
            <img src="/img/left.png" alt="WearIt" class="w-full h-full object-cover">
        </div>
                ...
                <div class="flex flex-col md:flex-row md:gap-5 gap-2 md:pb-1 pb-3">
                    ...
                    <div class="pb-1 md:pb-3 md:w-[50%]">
                        ...
                        <input type="Password" name="password_confirmation"
                            class="border 1px py-2 px-3 rounded-md w-full">
                    </div>
                </div>
                <div class="flex items-center">
                    <input type="checkbox"
                        class="w-4 h-4 shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                        id="hs-default-checkbox">
                    <label for="hs-default-checkbox" class="text-sm text-slate-950 ms-3">I agree to all the <a
                            class="text-blue-700">Terms</a> and <a class="text-blue-700">Privacy policy</a></label>
                </div>
                <div class="pt-10 flex flex-col md:flex-row md:gap-5 gap-2">
                    <div class="w-full md:w-[50%]">
                        <button class="font-semibold bg-blue-700 text-white py-2 px-3 rounded-md w-full">Create
                            Account</button>
                    </div>
                    <div class="w-full md:w-[50%]">
                        <a href="/login/oauth"
