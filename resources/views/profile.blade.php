...
@section('content')
    <div class="flex md:px-14 px-6 py-10 md:flex-row flex-col">
        <div class="md:w-[28%] w-full flex-row">
            ...
            <div class="mt-8">
                <a class="flex items-center gap-5 border border-b-0 px-4 md:py-4 py-3 border-primary rounded-t-md bg-primary" href="/profile">
                ...
                <a class="group flex items-center gap-5 border border-b-0 px-4 md:py-4 py-3 border-primary  hover:bg-primary hover:border-primary hover:text-white" href="/history">
                ...
                <a class="group flex items-center gap-5 border border-b-0 px-4 md:py-4 py-3 border-primary  hover:bg-primary hover:border-primary" href="/accsetting">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="group-hover:text-white size-8 text-primary">
