...
<body class="font-public-sans">
    <nav
        class="sidebar w-[320px] max-w-[calc(100%-80px)] bg-primary px-6 py-10 fixed left-0 top-0 bottom-0 z-30 transition-all duration-200 text-white">
        <div class="flex justify-between items-start">
            ...
            <button class="sidebar-btn-close sm:hidden">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
    ...
    <div class="sidebar-overlay fixed inset-0 bg-[rgba(0,0,0,0.3)] z-20"></div>
    <div class="lg:pl-[320px] w-full">
        <div class="px-8 py-5 bg-white sticky top-0 right-0 left-0 z-10 flex justify-between border-b">
            <button class="sm:hidden sidebar-btn">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <div class="relative">
                ...
                <div class="w-56 absolute top-[calc(100%+.5rem)] right-0 bg-white border rounded-lg hidden popover">
                    ...
                    <a href="/dashboard/account-settings" class="px-4 py-3 hover:bg-gray-100 flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="px-6 py-6 lg:px-12 lg:py-8 w-full">
            @yield('content')
        </div>
    </div>
